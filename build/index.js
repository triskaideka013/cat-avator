...
class ShipCapnCrew {
    ...
    setupGame() {
        // if (!!this.player1?.diceArray) {
        //     this.player1 = this.setupPlayer(this.player1.diceArray) // re-try
        //     this.player1.diceArray.forEach(d => {
        //         d.reset()
        //     })
        // } else {
        this.player1 = this.setupPlayer([]) // 1st game
        this.setupDice()
        // }
        this.gameover = false
        this.isTimedOut = false
...
let PLATFORMER_SONG_PLAYING = false;
const PLATFORMER_SONG = new Music(
    [
      [
        [,0,22,,.07,.07,2,0,,,.5,.01],
